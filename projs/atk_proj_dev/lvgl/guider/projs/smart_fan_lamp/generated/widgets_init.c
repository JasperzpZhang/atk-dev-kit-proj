...
extern int clock_analog_clock_1_hour_value;
extern int clock_analog_clock_1_min_value;
extern int clock_analog_clock_1_sec_value;

void clock_analog_clock_1_timer(lv_timer_t *timer)
{
    clock_count(&clock_analog_clock_1_hour_value, &clock_analog_clock_1_min_value, &clock_analog_clock_1_sec_value);
    if (lv_obj_is_valid(guider_ui.clock_analog_clock_1))
    {
      lv_analogclock_set_time(guider_ui.clock_analog_clock_1, clock_analog_clock_1_hour_value, clock_analog_clock_1_min_value, clock_analog_clock_1_sec_value);
    }
}
